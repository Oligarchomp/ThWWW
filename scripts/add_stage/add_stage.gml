...
function add_stage(stage){
	...
	switch(stage)
	{
		case 1:
			...
			add_stage_event(dialogue_s1_pre,60);
			...
			add_stage_event(dialogue_s1_post,80);
		break;
		case 2:
			...
			add_stage_event(act_s2_75,0);
			add_stage_event(act_s2_8,0);
			add_stage_event(act_s2_9,30);
			...
			add_stage_event(dialogue_s2_post,80);
		break;
		case 3:
			...
			add_stage_event(dialogue_s3_post,80);
		break;
		case 4:
			...
			add_stage_event(dialogue_s4_post,80);
		break;
		case 5:
			...
			add_stage_event(dialogue_s5_post,80);
		break;
		case 6:
