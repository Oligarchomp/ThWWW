...
switch(global.player_chosen)
{
	...
	case P_MARISA:
		...
		set_dialogue(spr_marisa_art,5,false,spr_apple_art,3,true,get_text("diag_s1_m9"),-1)
		set_dialogue(spr_marisa_art,1,true,spr_apple_art,3,false,get_text("diag_s1_m10"),-1)
