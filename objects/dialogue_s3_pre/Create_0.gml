...
switch(global.player_chosen)
{
	...
	case P_MARISA:
		...
		set_dialogue(spr_marisa_art,4,false,spr_pale_art,0,true,get_text("diag_s3_m4"),-1)
		set_dialogue(spr_marisa_art,2,true,spr_pale_art,0,false,get_text("diag_s3_m5"),-1)
