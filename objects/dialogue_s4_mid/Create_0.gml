...
switch(global.player_chosen)
{
	case P_REIMU:
		...
		set_dialogue(spr_reimu_art,0,false,spr_iku_art,2,true,get_text("diag_s4_r2"),150);
		set_dialogue(spr_reimu_art,1,true,spr_iku_art,2,false,get_text("diag_s4_r3"),150);
	...
	case P_MARISA:
		...
		set_dialogue(spr_marisa_art,0,false,spr_iku_art,2,true,get_text("diag_s4_m2"),150);
		set_dialogue(spr_marisa_art,0,true,spr_iku_art,2,false,get_text("diag_s4_m3"),150);
	...
	case P_SANAE:
		...
		set_dialogue(spr_sanae_art,3,false,spr_iku_art,2,true,get_text("diag_s4_s2"),150);
		set_dialogue(spr_sanae_art,2,true,spr_iku_art,2,false,get_text("diag_s4_s3"),150);
